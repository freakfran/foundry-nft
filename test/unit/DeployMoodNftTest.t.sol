...
contract DeployMoodNftTest is Test {
    ...
    function testConcertSvgToUri() public view {
        string memory uri = deployer.svgToImageURI(
        ...
        assert(keccak256(abi.encodePacked(uri)) == keccak256(abi.encodePacked(expected)));
    }
}
